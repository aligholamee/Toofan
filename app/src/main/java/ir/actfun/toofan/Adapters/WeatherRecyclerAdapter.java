package ir.actfun.toofan.Adapters;
...
import ir.actfun.toofan.activities.MainActivity;
import ir.actfun.toofan.R;
import ir.actfun.toofan.models.Weather;
import ir.actfun.toofan.models.WeatherViewHolder;
...
public class WeatherRecyclerAdapter extends RecyclerView.Adapter<WeatherViewHolder> {
    ...
    public WeatherViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        YoYo.with(Techniques.ZoomIn)
                .duration(200)
                .playOn(view.findViewById(R.id.item_in_row));
    ...
    public void onBindViewHolder(WeatherViewHolder customViewHolder, int i) {
        ...
        customViewHolder.itemyWind.setText(new DecimalFormat("#.0").format(wind) + " " +
                MainActivity.localize(sp, context, "speedUnit", "m/s")
                + " " + MainActivity.getWindDirectionString(sp, context, weatherItem));
        customViewHolder.itemPressure.setText(new DecimalFormat("#.0").format(pressure) + " " +
                MainActivity.localize(sp, context, "pressureUnit", "hPa"));
        customViewHolder.itemHumidity.setText(weatherItem.getHumidity() + " %");
