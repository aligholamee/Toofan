...
public class ExtensiveWidgetProvider extends AbstractWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for (int widgetId : appWidgetIds) {
            ...
            remoteViews.setTextViewText(R.id.widgetSunrise,timeFormat.format(widgetWeather.getSunrise()));
            remoteViews.setTextViewText(R.id.widgetSunset,timeFormat.format(widgetWeather.getSunset()));
